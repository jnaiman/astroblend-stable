...
# and install it on its own
INST_BLENDER=1 # link to blender?
...
INST_PY3=1      # Install Python 3 along with Python 2. If this is turned
...
function host_specific
{
	...
	echo "I assume your bash file is "$BASHFILE
        echo
...
then
    ...
    then
        ...
        cd $PYTHON3
        ( ./configure --with-ssl --prefix=${DEST_DIR}/ ${PYCONF_ARGS} 2>&1 ) 1>> ${LOG_FILE} || do_exit
...
then
    ...
    #echo "YOU have to have Mercurial already installed for this to work... sorry"
    #do_exit
else
...
echo "Installing nose... heheh, nose."
do_setup_py $NOSE
...
then
	...
	then
	    ...
	    echo "Oh noes!  You gotta install Blender first... bye bye :("
	    #exit 1
	    do_exit
	else
